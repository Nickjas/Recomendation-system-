...
ui <- fluidPage(
    ...
    fluidRow(                                    
        column(12,
               p("This recomendation system is based on items.Next time i will try to build an engine based on users history.A detailed description of this project, please visit my", 
                  
                 a("GitHub page", href = "https://github.com/Nickjas/Market_Basket_Analysis", target="_blank"))
        )
    )
)
